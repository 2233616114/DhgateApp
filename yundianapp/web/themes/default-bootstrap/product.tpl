...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
		...
		{if isset($product) && $product->description}
			...
			<section class="page-product-box">
				...
				<!-- full description -->
				<div  class="rte"><script type="text/template" id="tpl_detailwindow">{$product->description}</script><iframe id="detailwindow" width="100%" frameborder="0" ></iframe>
                                      <script>
                                          var detailIframe = document.getElementById("detailwindow");
                                          subw = detailIframe.contentWindow, timerCount = 50;
                                          subw.document.write('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">');
                                          subw.document.write(document.getElementById("tpl_detailwindow").innerHTML);
                                          subw.document.close();
