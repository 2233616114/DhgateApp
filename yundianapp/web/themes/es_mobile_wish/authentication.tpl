...
{capture name=path}
	...
	{/if}
{/capture}
<h1 class="page-heading hidden-xs">{if !isset($email_create)}{l s='Authentication'}{else}{l s='Create an account'}{/if}</h1>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
				<h4 class="page-subheading">{l s='Create an account'}</h4>
				<div class="form_content clearfix">
					...
					<div class="submit">
						...
						<button class="btn btn-default button button-medium exclusive col-xs-10 col-md-6" type="submit" id="SubmitCreate" name="SubmitCreate">
							<span>
		...
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
				...
				<div class="form_content clearfix">
					...
					<p class="submit">
						{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
						<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-default button-medium col-xs-10 col-md-6">
							<span>
