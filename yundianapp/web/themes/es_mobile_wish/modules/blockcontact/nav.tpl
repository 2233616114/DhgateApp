...
*}
<div class="hidden-xs" id="contact-link" {if isset($is_logged) && $is_logged} class="is_logged"{/if}>
...
{if $telnumber}
	<span class="hidden-xs shop-phone{if isset($is_logged) && $is_logged} is_logged{/if}">
