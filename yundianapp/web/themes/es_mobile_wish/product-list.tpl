...
{if isset($products) && $products}
	...
	<ul{if isset($id) && $id} id="{$id}"{/if} class="product_list grid row mobile-indent{if isset($class) && $class} {$class}{/if}">
			...
			<div class="product-container" itemscope itemtype="https://schema.org/Product">
				<div class="left-block">
					<div class="product-image-container">
						...
						{if isset($quick_view) && $quick_view}
							...
							<a class="quick-view-mobile hidden-xs" href="{$product.link|escape:'html':'UTF-8'}" rel="{$product.link|escape:'html':'UTF-8'}">
								...
								{if isset($product.show_price) && $product.show_price && !isset($restricted_country_mode)}
									...
									{if $product.price_without_reduction > 0 && isset($product.specific_prices) && $product.specific_prices && isset($product.specific_prices.reduction) && $product.specific_prices.reduction > 0}
										...
										{if $product.specific_prices.reduction_type == 'percentage'}
											<span class="price-percent-reduction hidden-xs">-{$product.specific_prices.reduction * 100}%</span>
										{/if}
									{/if}
						...
						{if isset($product.new) && $product.new == 1}
							<a class="new-box hidden-xs" href="{$product.link|escape:'html':'UTF-8'}">
								<span class="new-label">{l s='New'}</span>
							</a>
						{/if}
						{if isset($product.on_sale) && $product.on_sale && isset($product.show_price) && $product.show_price && !$PS_CATALOG_MODE}
							<a class="sale-box hidden-xs" href="{$product.link|escape:'html':'UTF-8'}">
				...
				<div class="right-block">
					...
					{if $smarty.capture.displayProductListReviews}
						<div class="hook-reviews hidden-xs">
					...
					{if isset($product.color_list)}
						<div class="color-list-container hidden-xs">{$product.color_list}</div>
					{/if}
