    ...
    t.infinitescroll.prototype = {
        _binding: function (t) {
            ...
            this._prefill = function () {
                ...
                s.bind("resize.infinite-scroll", function () {
                    if (o()) {
                        s.unbind("resize.infinite-scroll");
                        r.scroll()
                    }
                })
            };
            ...
            switch (f) {
                ...
                case"append":
                    ...
                    if (h) {
                        // modify by ccc --- 不显示 Page X
                        // var p = '<h2 id="product-page-' + u.state.currPage + '" class="infinite-scroll-page-title hidden-xs">Page ' + u.state.currPage + "</h2>";
                        // t(p).insertBefore(l.firstChild)
                    }
            ...
            if (u.animate) {
                var d = t(e).scrollTop() + t("#infscr-loading").height() + u.extraScrollPx + "px";
                t("html,body").animate({scrollTop: d}, 800, function () {
            ...
            o = t(r.contentSelector).is("table") ? t("<tbody/>") : t("<div/>");
