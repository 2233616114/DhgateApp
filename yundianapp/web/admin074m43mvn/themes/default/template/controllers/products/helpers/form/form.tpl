...
//				 $('.productTabs').show();
		...
		<form id="product_form" class="form-horizontal col-lg-12 col-md-11" action="{$form_action|escape:'html':'UTF-8'}" method="post" enctype="multipart/form-data" name="product" novalidate>
