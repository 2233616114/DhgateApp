...
<div id="product-shipping" class="panel product-tab">
	...
	<div class="form-group">
		<div class="col-lg-2 col-lg-offset-1">
			<label class="control-label col-lg-6" for="width">{$bullet_common_field} {l s='Package width'}</label>
		...
		<div class="col-lg-2">
			<label class="control-label col-lg-6" for="depth">{$bullet_common_field} {l s='Package depth'}</label>
			<div class="input-group col-lg-6">
				<span class="input-group-addon">{$ps_dimension_unit}</span>
		...
		<div class="col-lg-2">
			<label class="control-label col-lg-6" for="height">{$bullet_common_field} {l s='Package height'}</label>
			<div class="input-group col-lg-6">
				<span class="input-group-addon">{$ps_dimension_unit}</span>
	...
	<div class="form-group">
		<div class="col-lg-2 col-lg-offset-1">
			<label class="control-label col-lg-6" for="weight">{$bullet_common_field} {l s='Package weight'}</label>
			<div class="input-group col-lg-6">
		...
		<div class="col-lg-2">
			<label class="control-label col-lg-6" for="additional_shipping_cost">
