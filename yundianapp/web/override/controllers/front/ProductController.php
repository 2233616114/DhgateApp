...
class ProductControllerCore extends FrontController
{
    ...
    protected function assignPriceAndTax()
    {
        ...
        // add by ccc
        $combPriceImpacts = $this->queryCombPriceImpacts();
        ...
        $this->context->smarty->assign(array(
            ...
            // add by ccc
            'combPriceImpacts' => $combPriceImpacts,
            'initPrice' => $product_price,
        ));
    }
     ...
     * @return string
     */
    public function queryCombPriceImpacts()
    {
        $currency = (int)$this->context->cookie->id_currency;
        /* Build attributes combinations */
        $combinations = $this->product->getAttributeCombinations($this->context->language->id);
        $comb_array = array();
