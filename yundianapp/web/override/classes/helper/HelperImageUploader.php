...
class HelperImageUploaderCore extends HelperUploader
{
    ...
    public function getSavePath()
    {
        ...
        return $this->_normalizeDirectory(_PS_TMP_IMG_UPLOAD_DIR_);
    }
...
//        return tempnam($this->getSavePath(), $this->getUniqueFileName());
        ...
        if ($file_name == null) {
            ...
            $postfix = substr(strrchr($file_name, '.'), 1);
            return tempnam($this->getSavePath(), $this->getUniqueFileName()) . '.' . $postfix;
        }
    }
